...
| `SIMULATION_MAX_PASSIVE_DEPTH`                | 8                                                            | 実測の必要深度3に対し2.6倍の余裕。据え置きのうえmanifestへ明示する。                                                                                                                                    |
| `SIMULATION_MAX_EFFECTS_PER_SCOPE`            | 100                                                          | 実測の必要量40に対し旧値50は余裕1.25倍しかなく、正常な混成編成1件が`EXECUTION_LIMIT_EXCEEDED`で落ちていた。実測値の2.5倍へ引き上げる。                                                                  |
