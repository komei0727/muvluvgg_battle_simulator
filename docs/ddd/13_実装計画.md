...
- M2〜M8へ割り当てたルールの実装とRule Coverage（118件中117完了）
...
残作業の基準件数は[`17_残作業対応表.json`](./17_残作業対応表.json)の`current`を正本とし、固定値の転記を本書の正とはしない。参考として2026-08-05時点の実測値を記す。
...
| ------------------- | ---------------------: | ----------------------: |
| Domain Rule         |  109件中 47完了 / 62残 |   118件中 117完了 / 1残 |
