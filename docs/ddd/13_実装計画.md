...
- 41ルールのうち、M7として未完了のまま残るのは`R-EFF-05`・`R-EFF-09`・`R-TGT-06`の3件である。いずれも完了責任を持つTaskがclose済みで所有者不在だったため、`M7-012`（#266）・`M7-013`（#267）・`M7-019`（#273）へ再割当した。`R-EFF-09`は「`AppliedEffect`と`MarkerState`をまたぐカスケード」が未実装のまま完了計上されていたため未完了へ戻した。
