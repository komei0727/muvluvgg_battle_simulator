...
describe("production Catalog MEM_INCOGNITO_SISTER_ADVENTURE (お忍びシスターの冒険)", () => {
  it("IT-MEM-INCOGNITO-SISTER-ADVENTURE-001 [R-MEM-03]: every EffectAction manifests on exactly the declared slots with the declared magnitude when the ALLY side brings the Memory", () => {
    ...
    expect(observed.actionOrder).toEqual([
      {
        triggeredEffectIndex: 0,
        actionIds: ["ACT_MEM_INCOGNITO_SISTER_ADVENTURE_AFFILIATION_DEF_UP"],
      },
      {
        triggeredEffectIndex: 1,
        actionIds: ["ACT_MEM_INCOGNITO_SISTER_ADVENTURE_PHYSICAL_ATTACKER_ATK_UP"],
      },
    ]);
  ...
  it("IT-MEM-INCOGNITO-SISTER-ADVENTURE-005 [R-MEM-02] (R-MEM-02): keeps its API-declared slot in the resolution order when other Memories are brought alongside it, stacks onto the same slots, and its StateDeltas alone still reconstruct the started battle", () => {
