...
describe("production Catalog MEM_DISCONTENT_AND_ANXIETY (不満と不安)", () => {
  ...
  it("IT-MEM-DISCONTENT-AND-ANXIETY-002 (R-MEM-04): the same Memory declared by the ENEMY side lands on the mirrored slots and records ENEMY as the source side, never a granter unit", () => {
