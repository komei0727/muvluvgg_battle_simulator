...
describe("production Catalog MEM_MOMOZONO_NEW_YEAR (桃園家のお正月)", () => {
  it("IT-MEM-MOMOZONO-NEW-YEAR-001 [R-MEM-03]: every EffectAction manifests on exactly the declared slots with the declared magnitude when the ALLY side brings the Memory", () => {
  ...
  it("IT-MEM-MOMOZONO-NEW-YEAR-004 [R-MEM-02] (R-MEM-02): keeps its API-declared slot in the resolution order when other Memories are brought alongside it, stacks onto the same slots, and its StateDeltas alone still reconstruct the started battle", () => {
