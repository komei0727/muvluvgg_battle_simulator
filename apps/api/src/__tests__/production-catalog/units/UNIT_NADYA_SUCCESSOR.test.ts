...
describe("production Catalog UNIT_NADYA_SUCCESSOR (【輝ける次代の娘】ナージャ・ヴォルコワ)", () => {
  ...
  it("IT-UNIT-NADYA-SUCCESSOR-004 [R-SUB-02] (R-SUB-02): 4種の「ドルズィヤ」はどれもダメージタイプを宣言しないため、追加ダメージは**契機になった攻撃のタイプを引き継ぐ**。保持している数だけ1ヒットずつ、それぞれ自分の倍率で加わる", () => {
  ...
  it("IT-UNIT-NADYA-SUCCESSOR-005 [R-PS-01] (R-PS-01/R-STS-01/R-STS-02): PS1の「自身に状態異常」とPS2の「敵に気絶」は実 resolver が載せた分類・`statusKind` と帰属で分かれるが、自身への**気絶**はR-STS-02がPS1を発動直前に捨てるため炎上でしか成立しない", () => {
