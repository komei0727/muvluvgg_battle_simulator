...
const BEHAVIOURS: readonly SkillBehaviourCase[] = [
  ...
  },
  {
    ...
    expected: {
      actions: [
        {
          effectActionDefinitionId: "ACT_LUNA_HUNGRY_AS1_DAMAGE",
          targets: ["enemy:front"],
        },
      ],
      hpDeltas: {
...
describe("production Catalog UNIT_LUNA_HUNGRY (【博識なハングリーガール】ルナ・メロウ)", () => {
  ...
  it("IT-UNIT-LUNA-HUNGRY-004 [R-INT-01, R-INT-03] (R-INT-01 #1/#2/#4, R-INT-03): PS1が張った引き寄せ・肩代わり・反射は、以後の1発を味方からルナへ移して受けさせ、受けた量の75%を攻撃者へ返す（元ダメージは巻き戻さない）", () => {
