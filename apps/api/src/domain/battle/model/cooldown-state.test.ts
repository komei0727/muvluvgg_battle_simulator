...
describe("startCooldown", () => {
  ...
  it("an ACTION-unit cooldown set with no scope (e.g. a PS activated from a turn-boundary event outside any action) records an entry with no setActionId, so it decrements at the owner's next action regardless of that action's id", () => {
