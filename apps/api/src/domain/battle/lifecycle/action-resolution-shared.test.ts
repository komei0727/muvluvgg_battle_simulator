...
describe("increaseExGauge with a RESOURCE_GAIN_MOD rate (M7-002, Issue #185)", () => {
  ...
  it("UT-R-ACT-04-014: a composed rate below -100% (e.g. three stacked -50% RESOURCE_GAIN_MOD debuffs, R-FRM-03 same-UnitDefinition multi-deployment) floors the gain at 0 instead of driving the gauge negative", () => {
    const actor: BattleUnit = { ...unit("ACTOR"), currentExtraGauge: 0, maximumExtraGauge: 20 };
